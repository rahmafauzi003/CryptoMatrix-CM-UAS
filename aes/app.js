(function () {
  ...
  function updateInputLabels() {
    ...
    if (fmt === "hex") {
      ...
      els.dataInput.placeholder = mode === "encrypt"
        ...
        : "Contoh ciphertext hex: isi ciphertext 16 byte hasil enkripsi, misalnya dari output CryptoMatrix";
    } else {
      ...
      <section class="empty-state">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div class="max-w-3xl">
            ...
            <h2 class="mt-3 text-2xl font-black text-white">Masukkan payload untuk menjalankan CryptoMatrix AES-128</h2>
            <p class="mt-3 details-note">
              Isi payload manual, gunakan sampel CryptoMatrix, atau muat vector standar AES. Setelah eksekusi, sistem akan menampilkan pembentukan kunci, perubahan state setiap ronde, dan hasil akhir dalam format heksadesimal.
            </p>
          </div>
  ...
  function run() {
    try {
      ...
      showMessage("success", `${expected} selesai diproses oleh CryptoMatrix. Output: ${trace.outputHex}`);
    } catch (err) {
  ...
  function fillExampleHex() {
    ...
    updateInputLabels();
    showMessage("info", "Sampel hex CryptoMatrix telah dimuat. Klik 'Eksekusi Matrix' untuk memulai.");
  }
  ...
  function fillExampleText() {
    ...
    updateInputLabels();
    showMessage("info", "Sampel teks CryptoMatrix telah dimuat. Klik 'Eksekusi Matrix' untuk memulai.");
  }
